...
suite starter = [] {
   ...
   "json_schema"_test = [] {
      ...
      expect(
         schema ==
         R"({"type":"object","properties":{"arr":{"type":"array","items":{"$ref":"#/$defs/std::uint64_t"},"maxItems":3},"d":{"$ref":"#/$defs/double"},"hello":{"type":"string"},"i":{"$ref":"#/$defs/std::int32_t"}},"additionalProperties":false,"$defs":{"double":{"type":"number","minimum":-1.7976931348623157E308,"maximum":1.7976931348623157E308},"std::int32_t":{"type":"integer","minimum":-2147483648,"maximum":2147483647},"std::uint64_t":{"type":"integer","minimum":0,"maximum":18446744073709551615}},"title":"my_struct"})")
         << schema;
   };
